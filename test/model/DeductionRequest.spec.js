...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.DeductionRequest();
  });
  ...
  describe('DeductionRequest', function() {
    it('should create an instance of DeductionRequest', function() {
      // uncomment below and update the code to test DeductionRequest
      //var instane = new MergeHrisApi.DeductionRequest();
      //expect(instance).to.be.a(MergeHrisApi.DeductionRequest);
    });
    ...
    it('should have the property employeePayrollRun (base name: "employee_payroll_run")', function() {
      ...
      //var instance = new MergeHrisApi.DeductionRequest();
