...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.RemoteData();
  });
  ...
  describe('RemoteData', function() {
    it('should create an instance of RemoteData', function() {
      ...
      //var instane = new MergeHrisApi.RemoteData();
      //expect(instance).to.be.a(MergeHrisApi.RemoteData);
    });

    it('should have the property path (base name: "path")', function() {
      // uncomment below and update the code to test the property path
      //var instance = new MergeHrisApi.RemoteData();
