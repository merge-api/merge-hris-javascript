...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.TimeOffBalance();
  });
  ...
  describe('TimeOffBalance', function() {
    it('should create an instance of TimeOffBalance', function() {
      // uncomment below and update the code to test TimeOffBalance
      //var instane = new MergeHrisApi.TimeOffBalance();
      //expect(instance).to.be.a(MergeHrisApi.TimeOffBalance);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeHrisApi.TimeOffBalance();
    ...
    it('should have the property policy_type (base name: "policy_type")', function() {
      // uncomment below and update the code to test the property policy_type
      //var instance = new MergeHrisApi.TimeOffBalance();
      //expect(instance).to.be();
    });
