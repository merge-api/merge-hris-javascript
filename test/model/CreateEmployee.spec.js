...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.CreateEmployee();
  });
  ...
  describe('CreateEmployee', function() {
    it('should create an instance of CreateEmployee', function() {
      // uncomment below and update the code to test CreateEmployee
      //var instane = new MergeHrisApi.CreateEmployee();
      //expect(instance).to.be.a(MergeHrisApi.CreateEmployee);
    });

    it('should have the property company (base name: "company")', function() {
      // uncomment below and update the code to test the property company
      //var instance = new MergeHrisApi.CreateEmployee();
