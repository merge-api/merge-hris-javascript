...
(function(root, factory) {
  ...
  describe('Tax', function() {
    it('should create an instance of Tax', function() {
      ...
      //var instane = new MergeHrisApi.Tax();
      //expect(instance).to.be.a(MergeHrisApi.Tax);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeHrisApi.Tax();
    ...
    it('should have the property employer_tax (base name: "employer_tax")', function() {
      // uncomment below and update the code to test the property employer_tax
      //var instance = new MergeHrisApi.Tax();
      //expect(instance).to.be();
    });
