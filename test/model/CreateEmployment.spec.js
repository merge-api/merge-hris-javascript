...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.CreateEmployment();
  });
  ...
  describe('CreateEmployment', function() {
    it('should create an instance of CreateEmployment', function() {
      // uncomment below and update the code to test CreateEmployment
      //var instane = new MergeHrisApi.CreateEmployment();
      //expect(instance).to.be.a(MergeHrisApi.CreateEmployment);
    });
    ...
    it('should have the property jobTitle (base name: "job_title")', function() {
      ...
      //var instance = new MergeHrisApi.CreateEmployment();
