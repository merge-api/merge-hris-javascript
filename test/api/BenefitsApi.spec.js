...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.BenefitsApi();
  });
  ...
  describe('BenefitsApi', function() {
    ...
    describe('benefitsList', function() {
      it('should call benefitsList successfully', function(done) {
        ...
        //instance.benefitsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('benefitsRetrieve', function() {
      it('should call benefitsRetrieve successfully', function(done) {
        //uncomment below and update the code to test benefitsRetrieve
        //instance.benefitsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
