...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.DeductionsApi();
  });
  ...
  describe('DeductionsApi', function() {
    ...
    describe('deductionsRetrieve', function() {
      it('should call deductionsRetrieve successfully', function(done) {
        //uncomment below and update the code to test deductionsRetrieve
        //instance.deductionsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
