...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.TimeOffApi();
  });
  ...
  describe('TimeOffApi', function() {
    ...
    describe('timeOffRetrieve', function() {
      it('should call timeOffRetrieve successfully', function(done) {
        //uncomment below and update the code to test timeOffRetrieve
        //instance.timeOffRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
