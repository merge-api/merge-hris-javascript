...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeHrisApi.LocationsApi();
  });
  ...
  describe('LocationsApi', function() {
    ...
    describe('locationsRetrieve', function() {
      it('should call locationsRetrieve successfully', function(done) {
        //uncomment below and update the code to test locationsRetrieve
        //instance.locationsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
