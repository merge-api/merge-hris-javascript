...
> PaginatedPayGroupList payGroupsList(xAccountToken, opts)
...
apiInstance.payGroupsList(xAccountToken, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PayGroup payGroupsRetrieve(xAccountToken, id, opts)
...
apiInstance.payGroupsRetrieve(xAccountToken, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
