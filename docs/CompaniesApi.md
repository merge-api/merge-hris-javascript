...
> PaginatedCompanyList companiesList(x_account_token, opts)
...
apiInstance.companiesList(x_account_token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Company companiesRetrieve(x_account_token, id, opts)
...
apiInstance.companiesRetrieve(x_account_token, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
