...
> PaginatedTimeOffList timeOffList(authorization, xAccountToken, opts)
...
apiInstance.timeOffList(authorization, xAccountToken, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> TimeOff timeOffRetrieve(authorization, xAccountToken, id, opts)
...
apiInstance.timeOffRetrieve(authorization, xAccountToken, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
