...
var _TimeOffRequest = _interopRequireDefault(require("../model/TimeOffRequest"));
...
var TimeOffApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(TimeOffApi, [{
    key: "timeOffCreate",
    value: function timeOffCreate(xAccountToken, timeOffEndpointRequest, opts, callback) {
      opts = opts || {};
      var postBody = timeOffEndpointRequest; // verify the required parameter 'xAccountToken' is set
