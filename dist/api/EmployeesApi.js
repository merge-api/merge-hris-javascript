...
var _CreateEmployee = _interopRequireDefault(require("../model/CreateEmployee"));
...
var EmployeesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(EmployeesApi, [{
    key: "employeesCreate",
    value: function employeesCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createEmployee']; // verify the required parameter 'xAccountToken' is set
