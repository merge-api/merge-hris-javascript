...
var _CreateEmployeePayrollRun = _interopRequireDefault(require("../model/CreateEmployeePayrollRun"));
...
var EmployeePayrollRunsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(EmployeePayrollRunsApi, [{
    key: "employeePayrollRunsCreate",
    value: function employeePayrollRunsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createEmployeePayrollRun']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/employee-payroll-runs', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
