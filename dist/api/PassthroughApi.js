...
var PassthroughApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(PassthroughApi, [{
    ...
    value: function passthroughCreate(xAccountToken, dataPassthroughRequest, callback) {
      var postBody = dataPassthroughRequest; // verify the required parameter 'xAccountToken' is set
