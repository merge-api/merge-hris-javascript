...
var _EndUserDetails = _interopRequireDefault(require("../model/EndUserDetails"));
...
var LinkTokenApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(LinkTokenApi, [{
    key: "linkTokenCreate",
    value: function linkTokenCreate(endUserDetails, callback) {
      var postBody = endUserDetails; // verify the required parameter 'endUserDetails' is set
