...
var _CreateLocation = _interopRequireDefault(require("../model/CreateLocation"));
...
var LocationsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(LocationsApi, [{
    key: "locationsCreate",
    value: function locationsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createLocation']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/locations', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
