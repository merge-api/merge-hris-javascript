 ...
 * @version 1.0
 */
var RemoteKeyForRegeneration = /*#__PURE__*/function () {
  /**
   ...
   * @param name {String} 
   */
  function RemoteKeyForRegeneration(name) {
    _classCallCheck(this, RemoteKeyForRegeneration);
  ...
  _createClass(RemoteKeyForRegeneration, null, [{
    key: "initialize",
  ...
  return RemoteKeyForRegeneration;
}();
/**
 * @member {String} name
 */
...
var _default = RemoteKeyForRegeneration;
